<div class='wrap'>
	...
	<p><label><input type="checkbox" name="prevent_further_suicide" checked="checked" /> <b>Prevent further suicide?</b> (Deactivate plugin after use)</label></p>
